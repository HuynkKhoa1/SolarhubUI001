...
local Themes = {
    ...
    Solar = {
        Name = "Solar",
        Accent = Color3.fromRGB(142, 107, 255),  -- Bright purple accent
        AcrylicMain = Color3.fromRGB(10, 7, 20),  -- Very dark purple-black base
        AcrylicBorder = Color3.fromRGB(50, 30, 90),  -- Deep purple border
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(12, 8, 25), Color3.fromRGB(15, 10, 30)),  -- Deep space gradient
        AcrylicNoise = 0.95,  -- Cosmic noise effect
        TitleBarLine = Color3.fromRGB(60, 40, 100),  -- Deep purple for title bar
        Tab = Color3.fromRGB(90, 60, 160),  -- Rich purple for tabs
        Element = Color3.fromRGB(60, 40, 110),  -- Dark purple for elements
        ElementBorder = Color3.fromRGB(25, 15, 45),  -- Very dark purple borders
        InElementBorder = Color3.fromRGB(55, 35, 95),  -- Inner element borders
        ElementTransparency = 0.89,  -- Transparency for cosmic depth
        ToggleSlider = Color3.fromRGB(120, 80, 200),  -- Purple for toggles
        ToggleToggled = Color3.fromRGB(20, 10, 40),  -- Very dark when toggled
        SliderRail = Color3.fromRGB(100, 70, 170),  -- Purple slider rail
        DropdownFrame = Color3.fromRGB(110, 75, 190),  -- Purple dropdown
        DropdownHolder = Color3.fromRGB(20, 12, 40),  -- Dark holder
        DropdownBorder = Color3.fromRGB(30, 20, 55),  -- Dark purple border
        DropdownOption = Color3.fromRGB(100, 70, 170),  -- Purple options
        Keybind = Color3.fromRGB(100, 70, 170),  -- Purple keybind
        Input = Color3.fromRGB(100, 70, 170),  -- Purple input
        InputFocused = Color3.fromRGB(15, 10, 25),  -- Very dark when focused
        InputIndicator = Color3.fromRGB(140, 90, 230),  -- Bright purple indicator
        InputIndicatorFocus = Color3.fromRGB(160, 120, 255),  -- Bright purple when focused
        Dialog = Color3.fromRGB(20, 15, 40),  -- Dark dialog
        DialogHolder = Color3.fromRGB(15, 10, 30),  -- Darker holder
        DialogHolderLine = Color3.fromRGB(12, 8, 25),  -- Very dark line
        DialogButton = Color3.fromRGB(20, 15, 40),  -- Dark button
        DialogButtonBorder = Color3.fromRGB(60, 40, 110),  -- Purple button border
        DialogBorder = Color3.fromRGB(50, 30, 95),  -- Purple dialog border
        DialogInput = Color3.fromRGB(30, 20, 55),  -- Dark purple input
        DialogInputLine = Color3.fromRGB(120, 80, 210),  -- Purple input line
        Text = Color3.fromRGB(255, 255, 255),
        SubText = Color3.fromRGB(160, 140, 210),  -- Muted purple subtext
        Hover = Color3.fromRGB(130, 90, 220),  -- Purple hover
        HoverChange = 0.05,  -- Subtle hover effect
        
        -- Cosmic accents for star-like highlights
        CosmicAccents = {
            StarHighlight = Color3.fromRGB(190, 170, 255),  -- Bright star-like highlight
            DeepPurple = Color3.fromRGB(80, 50, 140),      -- Deep space purple
            CosmicBlack = Color3.fromRGB(5, 3, 15)         -- Near-black for deep space
        }
    }
}
...
Creator.Theme = Creator.Theme or "Solar"
...
function Creator.GetThemeProperty(Property)
	...
	return Creator.Themes.Solar[Property]
end
	...
	return function(Config)
		...
		TitleBar.Frame = New("Frame", {
			...
			New("Frame", {
                ...
                -- Thêm logo góc trái
                New("ImageLabel", {
                    Image = "rbxassetid://94361536997609",
                    Size = UDim2.fromOffset(45, 45), -- 📏 to hơn
                    BackgroundTransparency = 1,
                    ScaleType = Enum.ScaleType.Fit,
                    AnchorPoint = Vector2.new(0, 0.5),
                    Position = UDim2.new(0, 0, 0.5, -10), -- 🧭 canh giữa theo Y
                }),                
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "SolarHub_Settings"
